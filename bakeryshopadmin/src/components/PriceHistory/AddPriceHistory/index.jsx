...
const AddProduct = () => {
    ...
    const onCompressFile = async (file, index) => {
      ...
      const onSubmit = (data) => {
        ...
        // setImage([...image,  data.multipartFile[0]]);
        // setImage(image => [...image, data.multipartFile[0]]);
        // setImage(image => [...image, data.multipartFile[0]]);
        // this.setState(previousState => ({
        //     image: [...previousState.image, data.multipartFile[0]]
        // }));
        // image.push();
        // setImage(fileList.map((item) => item.data))
    ...
    //    Notification.error(JSON.stringify(fileList.map((item) => item.data)));
    
    
         
        // Notification.error(JSON.stringify(JSON.stringify(item[0])));
        
        // for (let item of catalogs) {
        //     // Notification.error(JSON.stringify(item));
        //     Notification.error(data.multipartFile[0].toString());
            
        //     data.catalogs = data.multipartFile[0];
        //     data.catalogs1 = JSON.stringify(item[0]);
        //     data.catalogs2 = JSON.stringify(item[0]);
        //     data.catalogs3 = JSON.stringify(item[0]);
        //     data.catalogs4 = JSON.stringify(item[0]);
        //     data.catalogs5 = JSON.stringify(item[0]);
        //     return ;
        //     // Notification.error(JSON.stringify(JSON.stringify(item[0])));
        //   }    

...
import { EmployeeGetAll, EmployeeStatusAction } from "../../store/actions/EmployeeAction";
...
const Employee = () => {
  ...
  const { employees, totalPages } = useSelector((state) => state.employee);
  ...
  const handleOnDelete = (username) => {
    dispatch(EmployeeStatusAction({ username, status: "delete" }));
  ...
  const handleOnReplay = (username) => {
    dispatch(EmployeeStatusAction({ username, status: "replay" }));
    Notification.success(EMPLOYEE_NOTIFICATION_WARN);
  };
    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            <PDFDownloadLink
              document={<Report employees={employees} />}
              fileName="report"
            >
              ...
              <TableRow key={u.id}>
                ...
                <TableCell>
                  <Visibility
                    ...
                    onClick={() => history.push("/employee/detail", { employee: u })}
                  />
                  {u.deletedAt ? (
                    <Replay

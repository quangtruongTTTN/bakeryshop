...
const DetailEmployee = () => {
  ...
  return (
    <>
      {Object.is(employee, undefined) && <Redirect to="/employee" />}
      <Grid container spacing={3}>
          ...
          <Grid container spacing={3} className={classes.wrapDetails}>
            <Grid item md={3}>
              <div className={classes.wrapAvatar}>
                <Avatar
                  src={employee?.linkImage ?? Logo}
                  alt={employee?.nameImage ?? "logo"}
                ...
                {/* <Typography variant="h6" component="span" className="mark">
                  Điểm: {employee?.memberVip?.mark ?? "0"}
                </Typography> */}
                <PDFDownloadLink
                  document={<Report employee={employee} />}
                  fileName="report"
                >
                  <Avatar
                    style={{
                ...
                <List>
                  <ListItem>
                    ...
                    <ListItemText
                      primary={
                        (
                          <Moment format="DD/MM/YYYY" date={employee?.birthday} />
        ...
        {/* <Grid item xs={12} sm={12} md={12}>
          ...
          {employee?.orders?.length > 0 &&
            !Object.is(
              employee?.orders?.findIndex((o) => !Object.is(o.payment, 0)),
              -1
                              ...
                              <Visibility
                                ...
                                onClick={() =>
                                  history.push("/order/detail", {
                                    order: { ...order, employeeId: employee },
                                  })
                                }
                                // onClick={() => console.log({ order: { ...order, employeeId: employee } })}
                              />
                            </TableCell>
                          </TableRow>
                        )

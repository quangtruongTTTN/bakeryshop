...
import { OrderListProcess, OrderListSuccess, OrderListFail, OrderGetById } from "../../store/actions/OrderAction";
...
const Order = () => {
    ...
    const { listProcess, totalPagesProcess, listSuccess, totalPagesSuccess, listFail, totalPagesFail, getByID } = useSelector((state) => state.order);
    ...
    const [valueToOrderByProcess, setValueToOrderByProcess] = useState("createdAt");
    const [valueToOrderBySuccess, setValueToOrderBySuccess] = useState("createdAt");
    const [valueToOrderByFail, setValueToOrderByFail] = useState("createdAt");

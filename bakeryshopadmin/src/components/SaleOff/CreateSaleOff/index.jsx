...
const CreateSaleOff = () => {
  ...
  const onSubmit = async (data) => {
    if(data.createdAt>data.endDate){
      ...
      // setTimeout(() => {
      //   dispatch(SaleOffAddAction(data)).then((res) => {
      //     if(res==='OK'){
      ...
      //   });  
      // }, 2000);
      await dispatch(SaleOffAddAction(data)).then((res) => {
        if(res==='OK'){
          // history.push("/saleoff");
          Notification.error("Thời gian sale bị trùng, Vui lòng chọn lại !");
        }else{
  ...
  const discounts = [
    ...
    { id: 3, label: "40%", discount: 0.4 },
    { id: 3, label: "50%", discount: 0.5 },
    { id: 3, label: "60%", discount: 0.6 },
    { id: 3, label: "70%", discount: 0.7 },
    { id: 3, label: "80%", discount: 0.8 },
    { id: 3, label: "90%", discount: 0.9 },
  ];

...
//
//import com.ptithcm.bakeryshopapi.payload.request.GroupMemberRequest;
//import com.ptithcm.bakeryshopapi.payload.request.WSGroupOrderRequest;
//
//import com.ptithcm.bakeryshopapi.payload.response.GroupOrderInfoResponse;
//import com.ptithcm.bakeryshopapi.payload.response.GroupOrderResponse;
...
//
//            GroupOrderDetails groupOrderDetails = groupOrderDetailsRepository.findByGroupMemberAndProductAndSizeOptionIdLike(groupMember, product,  size);
//
...
//            } else {
//                GroupOrderDetails groupOrderDetailsNew = new GroupOrderDetails(size,  quantity, currenPrice,

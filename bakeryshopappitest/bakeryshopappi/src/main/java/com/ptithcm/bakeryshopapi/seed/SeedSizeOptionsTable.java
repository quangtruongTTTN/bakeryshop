...
//            SizeOption sizeOption4 = new SizeOption(4 , "Small size", 10000);
            SizeOption sizeOption1 = new SizeOption(1 , "Normal size");
            SizeOption sizeOption2 = new SizeOption(2 , "Medium size");
            SizeOption sizeOption3 = new SizeOption(3 , "Big size ice");
            SizeOption sizeOption4 = new SizeOption(4 , "Small size");

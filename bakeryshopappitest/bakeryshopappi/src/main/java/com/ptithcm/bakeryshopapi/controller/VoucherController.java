...
//    @Autowired
//    private IVoucherRepository codeRepository;
...
//        }
//
//        if(codeRepository.existsByCodeName(voucherRequest.getCode())) {
...
//        Code code = codeRepository.findByCodeName(voucherRequest.getCode()).get();

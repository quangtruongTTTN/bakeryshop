...
//    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<?> getUsers(
        ...
        Page<User> users =
                userRepository.findEmployees("admin", pageable);
//        Page<User> users = "".equals(keyword) ?
//                userRepository.findEmployeesByUsernameNotLike("admin", pageable) :
//                userRepository.findEmployeesByUsernameNotLikeAndFullNameLike("admin", "%" + keyword + "%", pageable);
//        Page<User> users = "".equals(keyword) ?
